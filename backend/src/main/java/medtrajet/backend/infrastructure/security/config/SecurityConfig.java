package medtrajet.backend.infrastructure.security.config;

import medtrajet.backend.infrastructure.security.jwt.JwtFilter;
...
public class SecurityConfig {
    ...
    private final static List<String> urls = List.of("http://localhost:5173");
